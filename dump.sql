...
--
CREATE SEQUENCE public.address_address_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.assignment_assignment_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.client_client_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.contract_contract_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.payrollperiod_pay_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.personnel_deductions_deduct_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.personnel_personnel_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
--
CREATE SEQUENCE public.status_status_id_seq AS integer START WITH 1 INCREMENT BY 1 NO MINVALUE NO MAXVALUE CACHE 1;
...
ALTER COLUMN deduct_id
SET DEFAULT nextval(
        'public.personnel_deductions_deduct_id_seq'::regclass
    );
--
-- Name: salary salary_id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE ONLY public.salary
ALTER COLUMN salary_id
SET DEFAULT nextval('public.salary_salary_id_seq'::regclass);
--
-- Name: status status_id; Type: DEFAULT; Schema: public; Owner: postgres
--
ALTER TABLE ONLY public.status
ALTER COLUMN status_id
SET DEFAULT nextval('public.status_status_id_seq'::regclass);
--
...
SELECT pg_catalog.setval(
        'public.personnel_deductions_deduct_id_seq',
        1,
        false
    );
--
